...
- **Technolati** — `Technolati.com <https://www.technolati.com/>`_: This documentation is supported by Technolati, your go-to source for technology news, tutorials, and trends.
- **Verilog Guide** — `Verilog Design Guide <https://verilogguide.readthedocs.io/>`_: For those also working with Verilog, visit our companion guide.
...
.. toctree::
   :maxdepth: 2
   :caption: Advanced VHDL

   vhdl/structural_modeling
   vhdl/generics
   vhdl/packages_and_subprograms
   vhdl/vhdl_2008
...
- **Verilog Documentation** — `Verilog Guide <https://verilogguide.readthedocs.io/>`_
